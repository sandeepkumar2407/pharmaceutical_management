...
DELIMITER //
CREATE PROCEDURE UpdateTransactionTotalForAll()
BEGIN
    DECLARE done INT DEFAULT 0;
    DECLARE cur_bill_id INT;
    DECLARE cur CURSOR FOR SELECT DISTINCT bill_id FROM TRANSACTIONS;
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = 1;
    
    OPEN cur;
    read_loop: LOOP
        FETCH cur INTO cur_bill_id;
        IF done THEN
            LEAVE read_loop;
        END IF;
